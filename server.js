...
var staticdir = process.env.NODE_ENV === 'production' ? 'dist.prod/app' : 'dist.dev/app'; // get static files dir
...
// routes ==================================================
require('./devServer/routes')(express, app, staticdir); // configure our routes
